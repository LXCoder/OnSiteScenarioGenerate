...
from opendrive2tessng.opendrive2lanelet.opendriveparser.elements.opendrive import OpenDrive, Header
from opendrive2tessng.opendrive2lanelet.opendriveparser.elements.road import Road
from opendrive2tessng.opendrive2lanelet.opendriveparser.elements.roadLink import (
    Predecessor as RoadLinkPredecessor,
    Successor as RoadLinkSuccessor,
    Neighbor as RoadLinkNeighbor,
)
from opendrive2tessng.opendrive2lanelet.opendriveparser.elements.roadtype import (
    RoadType,
    Speed as RoadTypeSpeed,
)
from opendrive2tessng.opendrive2lanelet.opendriveparser.elements.roadElevationProfile import (
    ElevationRecord as RoadElevationProfile,
)
from opendrive2tessng.opendrive2lanelet.opendriveparser.elements.roadLateralProfile import (
...
from opendrive2tessng.opendrive2lanelet.opendriveparser.elements.junction import (
    Junction,
