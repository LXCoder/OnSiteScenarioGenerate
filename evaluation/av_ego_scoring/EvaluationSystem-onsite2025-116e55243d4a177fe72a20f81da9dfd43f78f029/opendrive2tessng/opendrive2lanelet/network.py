...
from opendrive2tessng.opendrive2lanelet.converter import OpenDriveConverter
...
class Network:
    ...
    def export_commonroad_scenario(
        ...
        """
        benchmark_id = None
        # Compatibility: different commonroad-io versions have different Scenario signatures.
        try:
            scenario = Scenario(
