...
def parse_opendrive_cbdes(path_opendrive: str) -> None:
    """
    ...
    for road in root.findall('road'):
        if len(road.findall('objects')) > 0:
            road_with_stopline.append(int(road.get("id")))
    ...
    junctions = openDriveXml.junctions
    ...
    return open_drive_info, name, road_with_stopline, junctions
